...
export function About() {
  return (
    <section id="o-nas" className="py-32 bg-background relative overflow-hidden border-y border-white/5 [perspective:1000px]">
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 bg-background/80 backdrop-blur-2xl p-6 md:p-10 rounded-2xl border border-white/10 shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-all duration-700 ease-[0.16,1,0.3,1] group-hover:border-primary/30" style={{ transform: "translateZ(30px)" }}>
              <div className="flex items-center gap-4 md:gap-8">
                <div className="text-4xl md:text-6xl font-display font-bold text-primary drop-shadow-[0_0_15px_rgba(212,175,55,0.5)]">15+</div>
          ...
          <div className="space-y-16 [transform-style:preserve-3d]">
            <div>
              ...
              <motion.h2
                ...
                className="font-display text-5xl md:text-6xl font-bold text-white leading-[1.1] tracking-tight drop-shadow-lg"
              >
              ...
              >
                Jsme lídrem na trhu v oblasti dodávky a montáže garážových vrat, stínící techniky a servisu oken. 
                Naším cílem je poskytovat řešení, která nejen skvěle vypadají, ale především bezchybně fungují.
              </motion.p>
            </div>
